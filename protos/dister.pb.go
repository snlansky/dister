...
const (
	...
	Message_TASK_PROCESS_REQUEST  Message_MessageType = 3
	Message_TASK_PROCESS_RESPONSE Message_MessageType = 4
...
var Message_MessageType_name = map[int32]string{
	...
	1:   "REGISTER_REQUEST",
	2:   "REGISTER_RESPONSE",
	3:   "TASK_PROCESS_REQUEST",
	4:   "TASK_PROCESS_RESPONSE",
	700: "PING_REQUEST",
	701: "PING_RESPONSE",
}
...
var Message_MessageType_value = map[string]int32{
	...
	"REGISTER_REQUEST":      1,
	"REGISTER_RESPONSE":     2,
	"TASK_PROCESS_REQUEST":  3,
	"TASK_PROCESS_RESPONSE": 4,
	"PING_REQUEST":          700,
	"PING_RESPONSE":         701,
}
...
var fileDescriptor_ffb07b0a572790a9 = []byte{
	...
	,
}
